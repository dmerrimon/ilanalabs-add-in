        ...
        try:
            ...
            response = self.azure_client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system", 
                        "content": "You are an expert clinical protocol analyst with deep knowledge of FDA/EMA regulations. Analyze text for regulatory compliance, clarity, and operational feasibility."
                    },
